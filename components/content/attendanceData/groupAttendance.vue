			...
			<view class="statistics">
				...
				<view class="scroll-box">
					<scroll-view scroll-x="true" class="scroll-X">
						<view class="group-member" v-for="(item,index) in groupList" 
						:key="index" :class="{'active-member': item.uid == currentUid}" @tap="changeMember(item)">
							{{item.name}}
						</view>
					</scroll-view>
				</view>
				...
				<view class="header">
					<text>月度考勤统计</text>
					<view class="picker-data" @tap="groupPicker">
						{{groupCurrentMonth}}
	...
	.statistics {
		...
		.scroll-X {
			...
			.active-member {
				...
				box-shadow: 0rpx 10rpx 20rpx 0rpx #BFDFFF;
			}
		}
